...
<div class="topnav">
  ...
  <a href="fuelstation.php">Fuel Stations</a>
...
<h4> &nbsp &nbsp &nbsp  > Due to growth of automobiles in market, fuel consumption became more.  In existing systm, unfortunately because of some reason if vehicle stops due to lack of petrol, it will be very hard  for the owner to push the vehicle to the nearest petrol pump.</h4>
<h4> &nbsp &nbsp &nbsp  > In this application three modules using user, fuel station, admin. Admin can verify Fuel Station details, then it will see user modules. Fuel Station can add their branch information like address and google map geo location and kind of fuel provide.</h4>
